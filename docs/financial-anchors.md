...
| Net interest expense | 18.3 | 20.7 | 19.6 | 17.5 | 18.7 |
| **Profit before tax** | **-4.3** | **0.9** | **13.2** | **23.1** | **15.5** |
| Income tax expense/(benefit) | 0.8 | 0.5 | 3.8 | 6.2 | 4.3 |
...
| Revolving credit facility | 15.1 | 23.8 | 16.3 | 6.8 | 11.4 |
...
| **Total liabilities** | **317.4** | **365.9** | **365.1** | **350.3** | **364.0** |
| Contributed capital and APIC | 166.0 | 167.2 | 168.6 | 170.1 | 170.1 |
| Retained earnings / (accumulated deficit) | -82.4 | -82.3 | -73.2 | -56.8 | -62.4 |
| Cumulative translation adjustment | 0.0 | -5.3 | 3.5 | 3.5 | 4.5 |
| Non-controlling interests | 3.1 | 3.2 | 3.5 | 3.7 | 3.7 |
| **Total equity** | **86.7** | **82.8** | **102.4** | **120.5** | **115.9** |
...
| Non-cash FX translation movement on working capital | 1.6 | -2.2 | 4.7 | 0.0 | -1.6 |
| Change in working capital | 2.2 | 2.8 | 1.0 | 4.7 | -5.4 |
| Change in other assets and liabilities | -0.2 | -0.4 | -0.4 | -0.2 | -0.2 |
| **NET CASH FROM OPERATING ACTIVITIES** | **14.3** | **19.1** | **34.0** | **41.6** | **24.3** |
...
| Revolving facility, net | 7.1 | 8.7 | -7.5 | -9.6 | -4.9 |
...
| **NET CASH FROM FINANCING ACTIVITIES** | **46.8** | **32.1** | **-11.9** | **-24.1** | **-9.5** |
...
| Memo: free cash flow (OCF less capex) | 1.8 | 5.1 | 18.5 | 24.1 | 9.3 |
...
| Net margin % | -1.6% | 0.1% | 2.3% | 3.8% | 2.6% |
...
| Total debt | 226.6 | 263.1 | 253.8 | 231.9 | 247.1 |
| Net debt | 211.6 | 248.1 | 231.8 | 209.9 | 225.1 |
| Net leverage (x Adj. EBITDA) | 5.42x | 5.26x | 4.01x | 3.31x | 3.80x |
| Interest coverage (x) | 2.14x | 2.28x | 2.94x | 3.62x | 3.16x |
| FCF conversion % of Adj. EBITDA | 4.7% | 10.8% | 32.1% | 38.0% | 15.6% |
| Total liquidity (cash + undrawn RCF) | 59.9 | 51.2 | 65.7 | 75.2 | 70.6 |
...
| Covenant headroom — interest coverage | 0.14x | 0.28x | 0.94x | 1.62x | 1.16x |
    ...
    **Deleveraging is the headline, and covenant headroom is the tension.** Net leverage falls
    ...
    4.01x at FY2025 against a covenant maximum that steps down
    6.00x / 5.50x / 5.00x / 4.50x across FY2023–FY2026. Headroom is genuinely tight early:
    0.58x at FY2023 and
    0.24x at FY2024, widening to
    0.99x at FY2025. Interest coverage improves from
    2.14x to 2.94x against a
    2.00x minimum — only 0.14x of headroom in FY2023.

    The FY2026 Forecast at 3.80x versus a Budget of
    3.31x costs
    0.50x
